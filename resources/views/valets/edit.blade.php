                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Valet Booking</h3>
                            </div>
                        </div>
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6">
                                                ...
                                                <x-text-input id="name" class="block mt-1 w-full" type="text"
                                                    name="name" autocomplete="name" value="{{ $valet->name }}" />
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <x-text-input id="booking_date" class="block mt-1 w-full" type="text"
                                                    name="booking_date" autocomplete="booking_date"  value="{{ $valet->booking_date }}" />
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($flexibilities as $flexibility)
                                                        <option {{ $flexibility->id == $valet->flexibility_id ? 'selected' : '' }} value="{{ $flexibility->id }}">{{ $flexibility->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($sizes as $size)
                                                        <option {{ $size->id == $valet->size_id ? 'selected' : '' }} value="{{ $size->id }}">{{ $size->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <x-text-input id="email" class="block mt-1 w-full" type="text"
                                                    name="email" autocomplete="email" value="{{ $valet->email }}" />
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <x-text-input id="contact_no" class="block mt-1 w-full" type="text"
                                                    name="contact_no" autocomplete="contact_no" value="{{ $valet->contact_no }}" />
